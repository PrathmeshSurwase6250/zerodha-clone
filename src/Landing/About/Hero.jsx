...
const Hero = () => {
  return (
    <div className='container  mt-5  '><br />
       <h5 style={{color : '#424242'}} className='mt-5 text-center'>We pioneered the discount broking model in India. <br />
Now, we are breaking ground with our technology.</h5><br />
    <div className="row mt-5 d-flex justify-content-center" style={{color : '#A0A0A0', fontSize : '13px' , letterSpacing : '1px'}}>
      <div className="col-4">
